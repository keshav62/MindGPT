...
<div className='flex-1 overflow-y-scroll mt-3 text-sm space-y-3'>
  {chats
    ...
    {/* User Accounts */}
    <div className='flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group dark:text-white '>
      <img src={assets.user_icon} className='w-4.5 not-dark:invert ' alt="" />
    ...
    <img src={assets.close_icon} className='absolute top-3 right-3 w-5 h-5 cursor-pointer md:hidden not-dark:invert '></img>
